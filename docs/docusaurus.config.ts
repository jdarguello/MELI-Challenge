...
const config: Config = {
  ...
  projectName: 'MELI-Challenge', // Usually your repo name.
      ...
      links: [
        {
          ...
          items: [
            {
              label: 'Repo',
              to: 'https://github.com/jdarguello/MELI-Challenge',
            },
          ],
        },
        {
          ...
          items: [
            {
              label: 'LinkedIn',
              href: 'https://www.linkedin.com/in/jdarp/',
            },
            {
              label: 'GitHub',
              href: 'https://github.com/jdarguello',
            },
          ],
        },
      ],
      copyright: `Copyright © ${new Date().getFullYear()} Mercado Libre. Built with Docusaurus.`,
    },
    prism: {
