...
### 3.1. Flujos operacionales

A continuación, se presentan los flujos propuestos para cada uno de los casos de concurrencia expuestos anteriormente. El diseño de estos ayudará a definir, mediante programación __reactiva__ y __funcional__ los trabajos que se deben hacer en _serie_ o en _paralelo_, optimizando el performance y la integridad de la información.
